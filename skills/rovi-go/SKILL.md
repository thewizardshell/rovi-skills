...
- **Swagger first — non-negotiable.** Always expose OpenAPI spec with swag comments. Without it, Orval cannot generate the frontend API layer. Do not skip or defer this step.
